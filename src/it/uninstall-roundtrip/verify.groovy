...
mvn(basedir, localRepositoryPath, ['-o', '-s', settings.absolutePath, 'ex:uninstall'], null, [:])
...
mvn(basedir, localRepositoryPath, ['-o', '-s', settings.absolutePath, fq('help')], null, [:]).assertSuccess()
